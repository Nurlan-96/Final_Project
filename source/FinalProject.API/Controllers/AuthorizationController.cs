...
namespace FinalProject.API.Controllers
{
    ...
    [ApiController]
    public class AuthorizationController(IJobRepository jobRepo, User.Module.Services.IAuthorizationService loginService, IJobService jobService) : ControllerBase
    {
