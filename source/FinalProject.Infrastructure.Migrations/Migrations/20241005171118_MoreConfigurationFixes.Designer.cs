...
namespace FinalProject.Infrastructure.Migrations.Migrations
{
    ...
    [Migration("20241005171118_MoreConfigurationFixes")]
    partial class MoreConfigurationFixes
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("FinalProject.Domain.Entities.JobPostEntity", b =>
                {
                    ...
                    b.Property<int?>("UserAppliedJobsId")
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("FinalProject.Domain.Entities.RoleAggregate.Role", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedDate = new DateTime(2024, 10, 5, 17, 11, 18, 299, DateTimeKind.Utc).AddTicks(9296),
                            Name = "SuperAdmin"
                        },
                        new
                        {
                            Id = 2,
                            CreatedDate = new DateTime(2024, 10, 5, 17, 11, 18, 299, DateTimeKind.Utc).AddTicks(9303),
                            Name = "User"
                        },
                        new
                        {
                            Id = 3,
                            CreatedDate = new DateTime(2024, 10, 5, 17, 11, 18, 299, DateTimeKind.Utc).AddTicks(9304),
                            Name = "Company"
                        });
                });

            modelBuilder.Entity("FinalProject.Domain.Entities.UserAppliedJobs", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("FinalProject.Domain.Entities.UserEntity", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedDate = new DateTime(2024, 10, 5, 17, 11, 18, 299, DateTimeKind.Utc).AddTicks(9454),
                            Email = "alex@example.com",
                            Fullname = "Alex Mercer",
                            IsBanned = false,
                            PasswordHash = "AQAAAAEACSfAAAAAEK8zAXF5GxYQdDNCUC0PWD7co8JCaa4svPzey5do14+4bDHKLXKwavndwnn6Jc4Bzg==",
                            PhoneNumber = "000000",
                            RoleId = 1
                        });
                });
            ...
            modelBuilder.Entity("FinalProject.Domain.Entities.JobPostEntity", b =>
                {
                    ...
                    b.HasOne("FinalProject.Domain.Entities.UserAppliedJobs", null)
                        .WithMany("JobPosts")
                        .HasForeignKey("UserAppliedJobsId");
